...
if (onnxruntime_ENABLE_TRAINING)
  ...
  file(GLOB onnxruntime_python_ortmodule_triton_srcs CONFIGURE_DEPENDS
    "${ORTTRAINING_SOURCE_DIR}/python/training/ortmodule/triton/*.py"
  )
  file(GLOB onnxruntime_python_ortmodule_triton_manual_srcs CONFIGURE_DEPENDS
    "${ORTTRAINING_SOURCE_DIR}/python/training/ortmodule/triton/manual/*.py"
  )
...
if (onnxruntime_ENABLE_TRAINING)
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E make_directory $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/training/ortmodule/triton
    COMMAND ${CMAKE_COMMAND} -E make_directory $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/training/ortmodule/triton/manual
    ...
    COMMAND ${CMAKE_COMMAND} -E copy
        ${onnxruntime_python_ortmodule_triton_srcs}
        $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/training/ortmodule/triton/
    COMMAND ${CMAKE_COMMAND} -E copy
        ${onnxruntime_python_ortmodule_triton_manual_srcs}
        $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/training/ortmodule/triton/manual/
    COMMAND ${CMAKE_COMMAND} -E copy
